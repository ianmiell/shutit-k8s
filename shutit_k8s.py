...
class shutit_k8s(ShutItModule):
	...
	def build(self, shutit):
		...
		shutit.build['module_name'] = 'shutit_k8s_' + ''.join(random.choice(string.ascii_letters + string.digits) for _ in range(6))
...
def module():
	return shutit_k8s(
		'shutit-k8s.shutit_k8s.shutit_k8s', 1498611222.0001,
		description='',
		maintainer='',
